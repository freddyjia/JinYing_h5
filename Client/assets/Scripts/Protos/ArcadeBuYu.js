...
var $root = $protobuf.roots.ArcadeBuYu || ($protobuf.roots.ArcadeBuYu = {});
...
$root.BuYuPlayerInfo = (function() {
     ...
     * @property {number} speed BuYuPlayerInfo speed
     */
    ...
    /**
     * BuYuPlayerInfo speed.
     * @member {number} speed
     * @memberof BuYuPlayerInfo
     * @instance
     */
    BuYuPlayerInfo.prototype.speed = 0;
    ...
    BuYuPlayerInfo.decode = function decode(r, l) {
        ...
        if (!m.hasOwnProperty("speed"))
            throw $util.ProtocolError("missing required 'speed'", { instance: m });
        return m;
    };
...
$root.RoomInfo = (function() {
     ...
     * @property {number} serverRoomId RoomInfo serverRoomId
     */
    ...
    /**
     * RoomInfo serverRoomId.
     * @member {number} serverRoomId
     * @memberof RoomInfo
     * @instance
     */
    RoomInfo.prototype.serverRoomId = 0;
    ...
    RoomInfo.encode = function encode(m, w) {
        ...
        w.uint32(32).int32(m.serverRoomId);
        return w;
    };
    ...
    RoomInfo.decode = function decode(r, l) {
        ...
        if (!m.hasOwnProperty("serverRoomId"))
            throw $util.ProtocolError("missing required 'serverRoomId'", { instance: m });
        return m;
    };
...
$root.SheetBuleetBack = (function() {
     ...
     * @property {string|null} [buleetArriveTime] SheetBuleetBack buleetArriveTime
     */
    ...
    /**
     * SheetBuleetBack buleetArriveTime.
     * @member {string} buleetArriveTime
     * @memberof SheetBuleetBack
     * @instance
     */
    SheetBuleetBack.prototype.buleetArriveTime = "";
    ...
    SheetBuleetBack.encode = function encode(m, w) {
        ...
        if (m.buleetArriveTime != null && m.hasOwnProperty("buleetArriveTime"))
            w.uint32(90).string(m.buleetArriveTime);
        return w;
    };
...
$root.SyncBulletData = (function() {
     ...
     * @property {number} speed SyncBulletData speed
     */
    ...
    /**
     * SyncBulletData speed.
     * @member {number} speed
     * @memberof SyncBulletData
     * @instance
     */
    SyncBulletData.prototype.speed = 0;
...
$root.BulletBoom = (function() {
     ...
     * @property {boolean|null} [isBoxFish] BulletBoom isBoxFish
     * @property {number|null} [times] BulletBoom times
     */
    ...
    /**
     * BulletBoom isBoxFish.
     * @member {boolean} isBoxFish
     * @memberof BulletBoom
     * @instance
     */
    BulletBoom.prototype.isBoxFish = false;
    ...
    BulletBoom.encode = function encode(m, w) {
        ...
        if (m.isBoxFish != null && m.hasOwnProperty("isBoxFish"))
            w.uint32(64).bool(m.isBoxFish);
        if (m.times != null && m.hasOwnProperty("times"))
            w.uint32(72).int32(m.times);
        return w;
    };
...
$root.SpeedUpDown = (function() {

    /**
     * Properties of a SpeedUpDown.
     * @exports ISpeedUpDown
     * @interface ISpeedUpDown
     * @property {number} speed SpeedUpDown speed
     */

    /**
     * Constructs a new SpeedUpDown.
     * @exports SpeedUpDown
     * @classdesc Represents a SpeedUpDown.
     * @implements ISpeedUpDown
     * @constructor
     * @param {ISpeedUpDown=} [p] Properties to set
     */
    function SpeedUpDown(p) {
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
                    this[ks[i]] = p[ks[i]];
     ...
     * SpeedUpDown speed.
     * @member {number} speed
     * @memberof SpeedUpDown
     * @instance
     */
    SpeedUpDown.prototype.speed = 0;

    /**
     * Creates a new SpeedUpDown instance using the specified properties.
     * @function create
     * @memberof SpeedUpDown
     * @static
     * @param {ISpeedUpDown=} [properties] Properties to set
     * @returns {SpeedUpDown} SpeedUpDown instance
     */
    SpeedUpDown.create = function create(properties) {
        return new SpeedUpDown(properties);
    };

    /**
     * Encodes the specified SpeedUpDown message. Does not implicitly {@link SpeedUpDown.verify|verify} messages.
     * @function encode
     * @memberof SpeedUpDown
     * @static
     * @param {ISpeedUpDown} m SpeedUpDown message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    SpeedUpDown.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.speed);
        return w;
    };

    /**
     * Decodes a SpeedUpDown message from the specified reader or buffer.
     * @function decode
     * @memberof SpeedUpDown
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {SpeedUpDown} SpeedUpDown
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SpeedUpDown.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.SpeedUpDown();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
...
$root.SpeedUpDownBack = (function() {

    /**
     * Properties of a SpeedUpDownBack.
     * @exports ISpeedUpDownBack
     * @interface ISpeedUpDownBack
     * @property {number} seatid SpeedUpDownBack seatid
     * @property {number} speed SpeedUpDownBack speed
     */

    /**
     * Constructs a new SpeedUpDownBack.
     * @exports SpeedUpDownBack
     * @classdesc Represents a SpeedUpDownBack.
     * @implements ISpeedUpDownBack
     * @constructor
     * @param {ISpeedUpDownBack=} [p] Properties to set
     */
    function SpeedUpDownBack(p) {
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
                    this[ks[i]] = p[ks[i]];
    ...
    /**
     * SpeedUpDownBack seatid.
     * @member {number} seatid
     * @memberof SpeedUpDownBack
     * @instance
     */
    SpeedUpDownBack.prototype.seatid = 0;

    /**
     * SpeedUpDownBack speed.
     * @member {number} speed
     * @memberof SpeedUpDownBack
     * @instance
     */
    SpeedUpDownBack.prototype.speed = 0;

    /**
     * Creates a new SpeedUpDownBack instance using the specified properties.
     * @function create
     * @memberof SpeedUpDownBack
     * @static
     * @param {ISpeedUpDownBack=} [properties] Properties to set
     * @returns {SpeedUpDownBack} SpeedUpDownBack instance
     */
    SpeedUpDownBack.create = function create(properties) {
        return new SpeedUpDownBack(properties);
    };

    /**
     * Encodes the specified SpeedUpDownBack message. Does not implicitly {@link SpeedUpDownBack.verify|verify} messages.
     * @function encode
     * @memberof SpeedUpDownBack
     * @static
     * @param {ISpeedUpDownBack} m SpeedUpDownBack message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    SpeedUpDownBack.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.seatid);
        w.uint32(16).int32(m.speed);
        return w;
    };

    /**
     * Decodes a SpeedUpDownBack message from the specified reader or buffer.
     * @function decode
     * @memberof SpeedUpDownBack
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {SpeedUpDownBack} SpeedUpDownBack
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    SpeedUpDownBack.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.SpeedUpDownBack();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
