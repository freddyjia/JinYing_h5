...
export class SheetBuleetBack implements ISheetBuleetBack {
    ...
    /** SheetBuleetBack buleetArriveTime. */
    public buleetArriveTime: string;
...
export interface ISpeedUpDown {

    /** SpeedUpDown speed */
    speed: number;
}

/** Represents a SpeedUpDown. */
export class SpeedUpDown implements ISpeedUpDown {

    /**
     * Constructs a new SpeedUpDown.
     * @param [p] Properties to set
     */
    constructor(p?: ISpeedUpDown);
     ...
     * @param [properties] Properties to set
     * @returns SpeedUpDown instance
     */
    public static create(properties?: ISpeedUpDown): SpeedUpDown;

    /**
     * Encodes the specified SpeedUpDown message. Does not implicitly {@link SpeedUpDown.verify|verify} messages.
     * @param m SpeedUpDown message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: ISpeedUpDown, w?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): SpeedUpDown;
}

/** Properties of a SpeedUpDownBack. */
export interface ISpeedUpDownBack {
...
/** Represents a SpeedUpDownBack. */
export class SpeedUpDownBack implements ISpeedUpDownBack {

    /**
     * Constructs a new SpeedUpDownBack.
     * @param [p] Properties to set
     */
    constructor(p?: ISpeedUpDownBack);
     ...
     * @param [properties] Properties to set
     * @returns SpeedUpDownBack instance
     */
    public static create(properties?: ISpeedUpDownBack): SpeedUpDownBack;

    /**
     * Encodes the specified SpeedUpDownBack message. Does not implicitly {@link SpeedUpDownBack.verify|verify} messages.
     * @param m SpeedUpDownBack message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: ISpeedUpDownBack, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a SpeedUpDownBack message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns SpeedUpDownBack
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): SpeedUpDownBack;
}
