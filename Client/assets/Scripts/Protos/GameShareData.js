...
var $root = $protobuf.roots.GameShareData || ($protobuf.roots.GameShareData = {});

$root.BrandRoadData = (function() {

    /**
     * Properties of a BrandRoadData.
     * @exports IBrandRoadData
     * @interface IBrandRoadData
     * @property {number} baseRoomId BrandRoadData baseRoomId
     * @property {number} playId BrandRoadData playId
     * @property {IBaiJiaLeRecord} record BrandRoadData record
     */

    /**
     * Constructs a new BrandRoadData.
     * @exports BrandRoadData
     * @classdesc Represents a BrandRoadData.
     * @implements IBrandRoadData
     * @constructor
     * @param {IBrandRoadData=} [p] Properties to set
     */
    function BrandRoadData(p) {
        if (p)
    ...
    /**
     * BrandRoadData baseRoomId.
     * @member {number} baseRoomId
     * @memberof BrandRoadData
     * @instance
     */
    BrandRoadData.prototype.baseRoomId = 0;

    /**
     * BrandRoadData playId.
     * @member {number} playId
     * @memberof BrandRoadData
     * @instance
     */
    BrandRoadData.prototype.playId = 0;

    /**
     * BrandRoadData record.
     * @member {IBaiJiaLeRecord} record
     * @memberof BrandRoadData
     * @instance
     */
    BrandRoadData.prototype.record = null;

    /**
     * Creates a new BrandRoadData instance using the specified properties.
     * @function create
     * @memberof BrandRoadData
     * @static
     * @param {IBrandRoadData=} [properties] Properties to set
     * @returns {BrandRoadData} BrandRoadData instance
     */
    BrandRoadData.create = function create(properties) {
        return new BrandRoadData(properties);
    };

    /**
     * Encodes the specified BrandRoadData message. Does not implicitly {@link BrandRoadData.verify|verify} messages.
     * @function encode
     * @memberof BrandRoadData
     * @static
     * @param {IBrandRoadData} m BrandRoadData message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    BrandRoadData.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.baseRoomId);
        w.uint32(16).int32(m.playId);
        $root.BaiJiaLeRecord.encode(m.record, w.uint32(26).fork()).ldelim();
        return w;
    };

    /**
     * Decodes a BrandRoadData message from the specified reader or buffer.
     * @function decode
     * @memberof BrandRoadData
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {BrandRoadData} BrandRoadData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    BrandRoadData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.BrandRoadData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
                m.baseRoomId = r.int32();
                break;
            case 2:
                m.playId = r.int32();
                break;
            case 3:
                m.record = $root.BaiJiaLeRecord.decode(r, r.uint32());
                break;
            default:
                r.skipType(t & 7);
                break;
        ...
        if (!m.hasOwnProperty("baseRoomId"))
            throw $util.ProtocolError("missing required 'baseRoomId'", { instance: m });
    ...
    return BrandRoadData;
})();

$root.ReqBrandRoadData = (function() {

    /**
     * Properties of a ReqBrandRoadData.
     * @exports IReqBrandRoadData
     * @interface IReqBrandRoadData
     * @property {number} baseRoomId ReqBrandRoadData baseRoomId
     */

    /**
     * Constructs a new ReqBrandRoadData.
     * @exports ReqBrandRoadData
     * @classdesc Represents a ReqBrandRoadData.
     * @implements IReqBrandRoadData
     * @constructor
     * @param {IReqBrandRoadData=} [p] Properties to set
     */
    function ReqBrandRoadData(p) {
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
                    this[ks[i]] = p[ks[i]];
    ...
    /**
     * ReqBrandRoadData baseRoomId.
     * @member {number} baseRoomId
     * @memberof ReqBrandRoadData
     * @instance
     */
    ReqBrandRoadData.prototype.baseRoomId = 0;

    /**
     * Creates a new ReqBrandRoadData instance using the specified properties.
     * @function create
     * @memberof ReqBrandRoadData
     * @static
     * @param {IReqBrandRoadData=} [properties] Properties to set
     * @returns {ReqBrandRoadData} ReqBrandRoadData instance
     */
    ReqBrandRoadData.create = function create(properties) {
        return new ReqBrandRoadData(properties);
    };

    /**
     * Encodes the specified ReqBrandRoadData message. Does not implicitly {@link ReqBrandRoadData.verify|verify} messages.
     * @function encode
     * @memberof ReqBrandRoadData
     * @static
     * @param {IReqBrandRoadData} m ReqBrandRoadData message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ReqBrandRoadData.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.baseRoomId);
        return w;
    ...
    /**
     * Decodes a ReqBrandRoadData message from the specified reader or buffer.
     * @function decode
     * @memberof ReqBrandRoadData
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {ReqBrandRoadData} ReqBrandRoadData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ReqBrandRoadData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.ReqBrandRoadData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
    ...
    return ReqBrandRoadData;
})();

$root.RspBrandRoadData = (function() {

    /**
     * Properties of a RspBrandRoadData.
     * @exports IRspBrandRoadData
     * @interface IRspBrandRoadData
     * @property {number} baseRoomId RspBrandRoadData baseRoomId
     * @property {Array.<IBaiJiaLeRecord>|null} [records] RspBrandRoadData records
     */

    /**
     * Constructs a new RspBrandRoadData.
     * @exports RspBrandRoadData
     * @classdesc Represents a RspBrandRoadData.
     * @implements IRspBrandRoadData
     * @constructor
     * @param {IRspBrandRoadData=} [p] Properties to set
     */
    function RspBrandRoadData(p) {
        this.records = [];
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
    ...
    /**
     * RspBrandRoadData baseRoomId.
     * @member {number} baseRoomId
     * @memberof RspBrandRoadData
     * @instance
     */
    RspBrandRoadData.prototype.baseRoomId = 0;

    /**
     * RspBrandRoadData records.
     * @member {Array.<IBaiJiaLeRecord>} records
     * @memberof RspBrandRoadData
     * @instance
     */
    RspBrandRoadData.prototype.records = $util.emptyArray;

    /**
     * Creates a new RspBrandRoadData instance using the specified properties.
     * @function create
     * @memberof RspBrandRoadData
     * @static
     * @param {IRspBrandRoadData=} [properties] Properties to set
     * @returns {RspBrandRoadData} RspBrandRoadData instance
     */
    RspBrandRoadData.create = function create(properties) {
        return new RspBrandRoadData(properties);
    };

    /**
     * Encodes the specified RspBrandRoadData message. Does not implicitly {@link RspBrandRoadData.verify|verify} messages.
     * @function encode
     * @memberof RspBrandRoadData
     * @static
     * @param {IRspBrandRoadData} m RspBrandRoadData message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    RspBrandRoadData.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.baseRoomId);
        if (m.records != null && m.records.length) {
            for (var i = 0; i < m.records.length; ++i)
                $root.BaiJiaLeRecord.encode(m.records[i], w.uint32(18).fork()).ldelim();
        }
        return w;
    };

    /**
     * Decodes a RspBrandRoadData message from the specified reader or buffer.
     * @function decode
     * @memberof RspBrandRoadData
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {RspBrandRoadData} RspBrandRoadData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    RspBrandRoadData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.RspBrandRoadData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
            ...
            case 2:
                if (!(m.records && m.records.length))
                    m.records = [];
                m.records.push($root.BaiJiaLeRecord.decode(r, r.uint32()));
                break;
            default:
                r.skipType(t & 7);
                break;
    ...
    return RspBrandRoadData;
})();

$root.BaiJiaLeRecord = (function() {

    /**
     * Properties of a BaiJiaLeRecord.
     * @exports IBaiJiaLeRecord
     * @interface IBaiJiaLeRecord
     * @property {Array.<number>|null} [resultType] BaiJiaLeRecord resultType
     * @property {boolean} isClear BaiJiaLeRecord isClear
     */

    /**
     * Constructs a new BaiJiaLeRecord.
     * @exports BaiJiaLeRecord
     * @classdesc Represents a BaiJiaLeRecord.
     * @implements IBaiJiaLeRecord
     * @constructor
     * @param {IBaiJiaLeRecord=} [p] Properties to set
     */
    function BaiJiaLeRecord(p) {
        this.resultType = [];
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
    ...
    /**
     * BaiJiaLeRecord resultType.
     * @member {Array.<number>} resultType
     * @memberof BaiJiaLeRecord
     * @instance
     */
    BaiJiaLeRecord.prototype.resultType = $util.emptyArray;

    /**
     * BaiJiaLeRecord isClear.
     * @member {boolean} isClear
     * @memberof BaiJiaLeRecord
     * @instance
     */
    BaiJiaLeRecord.prototype.isClear = false;

    /**
     * Creates a new BaiJiaLeRecord instance using the specified properties.
     * @function create
     * @memberof BaiJiaLeRecord
     * @static
     * @param {IBaiJiaLeRecord=} [properties] Properties to set
     * @returns {BaiJiaLeRecord} BaiJiaLeRecord instance
     */
    BaiJiaLeRecord.create = function create(properties) {
        return new BaiJiaLeRecord(properties);
    };

    /**
     * Encodes the specified BaiJiaLeRecord message. Does not implicitly {@link BaiJiaLeRecord.verify|verify} messages.
     * @function encode
     * @memberof BaiJiaLeRecord
     * @static
     * @param {IBaiJiaLeRecord} m BaiJiaLeRecord message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    BaiJiaLeRecord.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        if (m.resultType != null && m.resultType.length) {
            for (var i = 0; i < m.resultType.length; ++i)
                w.uint32(8).int32(m.resultType[i]);
        }
        w.uint32(16).bool(m.isClear);
        return w;
    };

    /**
     * Decodes a BaiJiaLeRecord message from the specified reader or buffer.
     * @function decode
     * @memberof BaiJiaLeRecord
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {BaiJiaLeRecord} BaiJiaLeRecord
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    BaiJiaLeRecord.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.BaiJiaLeRecord();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
                if (!(m.resultType && m.resultType.length))
                    m.resultType = [];
                if ((t & 7) === 2) {
                    var c2 = r.uint32() + r.pos;
                    while (r.pos < c2)
                        m.resultType.push(r.int32());
                } else
                    m.resultType.push(r.int32());
                break;
            case 2:
    ...
    return BaiJiaLeRecord;
})();

$root.RoomStatusData = (function() {

    /**
     * Properties of a RoomStatusData.
     * @exports IRoomStatusData
     * @interface IRoomStatusData
     * @property {number} type RoomStatusData type
     * @property {string} roomName RoomStatusData roomName
     * @property {string} limitRed RoomStatusData limitRed
     * @property {number} maxPlayers RoomStatusData maxPlayers
     * @property {number} currPlayers RoomStatusData currPlayers
     * @property {number} roomBaseId RoomStatusData roomBaseId
     * @property {number} restTime RoomStatusData restTime
     * @property {number} totalTime RoomStatusData totalTime
     * @property {GameState} currState RoomStatusData currState
     * @property {boolean} isPrivate RoomStatusData isPrivate
     * @property {Array.<ISeatInfo>|null} [seatRoleInfos] RoomStatusData seatRoleInfos
     */

    /**
     * Constructs a new RoomStatusData.
     * @exports RoomStatusData
     * @classdesc Represents a RoomStatusData.
     * @implements IRoomStatusData
     * @constructor
     * @param {IRoomStatusData=} [p] Properties to set
     */
    function RoomStatusData(p) {
        this.seatRoleInfos = [];
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
     ...
     * RoomStatusData type.
     * @member {number} type
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.type = 0;

    /**
     * RoomStatusData roomName.
     * @member {string} roomName
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.roomName = "";

    /**
     * RoomStatusData limitRed.
     * @member {string} limitRed
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.limitRed = "";

    /**
     * RoomStatusData maxPlayers.
     * @member {number} maxPlayers
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.maxPlayers = 0;

    /**
     * RoomStatusData currPlayers.
     * @member {number} currPlayers
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.currPlayers = 0;

    /**
     * RoomStatusData roomBaseId.
     * @member {number} roomBaseId
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.roomBaseId = 0;

    /**
     * RoomStatusData restTime.
     * @member {number} restTime
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.restTime = 0;

    /**
     * RoomStatusData totalTime.
     * @member {number} totalTime
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.totalTime = 0;

    /**
     * RoomStatusData currState.
     * @member {GameState} currState
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.currState = 1;

    /**
     * RoomStatusData isPrivate.
     * @member {boolean} isPrivate
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.isPrivate = false;

    /**
     * RoomStatusData seatRoleInfos.
     * @member {Array.<ISeatInfo>} seatRoleInfos
     * @memberof RoomStatusData
     * @instance
     */
    RoomStatusData.prototype.seatRoleInfos = $util.emptyArray;

    /**
     * Creates a new RoomStatusData instance using the specified properties.
     * @function create
     * @memberof RoomStatusData
     * @static
     * @param {IRoomStatusData=} [properties] Properties to set
     * @returns {RoomStatusData} RoomStatusData instance
     */
    RoomStatusData.create = function create(properties) {
        return new RoomStatusData(properties);
    };

    /**
     * Encodes the specified RoomStatusData message. Does not implicitly {@link RoomStatusData.verify|verify} messages.
     * @function encode
     * @memberof RoomStatusData
     * @static
     * @param {IRoomStatusData} m RoomStatusData message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    RoomStatusData.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.type);
        w.uint32(18).string(m.roomName);
        w.uint32(26).string(m.limitRed);
        w.uint32(32).int32(m.maxPlayers);
        w.uint32(40).int32(m.currPlayers);
        w.uint32(48).int32(m.roomBaseId);
        w.uint32(56).int32(m.restTime);
        w.uint32(64).int32(m.totalTime);
        w.uint32(72).int32(m.currState);
        w.uint32(80).bool(m.isPrivate);
        if (m.seatRoleInfos != null && m.seatRoleInfos.length) {
            for (var i = 0; i < m.seatRoleInfos.length; ++i)
                $root.SeatInfo.encode(m.seatRoleInfos[i], w.uint32(90).fork()).ldelim();
        }
        return w;
    };

    /**
     * Decodes a RoomStatusData message from the specified reader or buffer.
     * @function decode
     * @memberof RoomStatusData
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {RoomStatusData} RoomStatusData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    RoomStatusData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.RoomStatusData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
            ...
            case 10:
                ...
                break;
            case 11:
                if (!(m.seatRoleInfos && m.seatRoleInfos.length))
                    m.seatRoleInfos = [];
                m.seatRoleInfos.push($root.SeatInfo.decode(r, r.uint32()));
                break;
            default:
                r.skipType(t & 7);
                break;
...
$root.ArcadeBuYuStockChangeData = (function() {

    /**
     * Properties of an ArcadeBuYuStockChangeData.
     * @exports IArcadeBuYuStockChangeData
     * @interface IArcadeBuYuStockChangeData
     * @property {number} playId ArcadeBuYuStockChangeData playId
     * @property {number|Long} changeValue ArcadeBuYuStockChangeData changeValue
     */

    /**
     * Constructs a new ArcadeBuYuStockChangeData.
     * @exports ArcadeBuYuStockChangeData
     * @classdesc Represents an ArcadeBuYuStockChangeData.
     * @implements IArcadeBuYuStockChangeData
     * @constructor
     * @param {IArcadeBuYuStockChangeData=} [p] Properties to set
     */
    function ArcadeBuYuStockChangeData(p) {
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
                    this[ks[i]] = p[ks[i]];
    ...
    /**
     * ArcadeBuYuStockChangeData playId.
     * @member {number} playId
     * @memberof ArcadeBuYuStockChangeData
     * @instance
     */
    ArcadeBuYuStockChangeData.prototype.playId = 0;

    /**
     * ArcadeBuYuStockChangeData changeValue.
     * @member {number|Long} changeValue
     * @memberof ArcadeBuYuStockChangeData
     * @instance
     */
    ArcadeBuYuStockChangeData.prototype.changeValue = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

    /**
     * Creates a new ArcadeBuYuStockChangeData instance using the specified properties.
     * @function create
     * @memberof ArcadeBuYuStockChangeData
     * @static
     * @param {IArcadeBuYuStockChangeData=} [properties] Properties to set
     * @returns {ArcadeBuYuStockChangeData} ArcadeBuYuStockChangeData instance
     */
    ArcadeBuYuStockChangeData.create = function create(properties) {
        return new ArcadeBuYuStockChangeData(properties);
    };

    /**
     * Encodes the specified ArcadeBuYuStockChangeData message. Does not implicitly {@link ArcadeBuYuStockChangeData.verify|verify} messages.
     * @function encode
     * @memberof ArcadeBuYuStockChangeData
     * @static
     * @param {IArcadeBuYuStockChangeData} m ArcadeBuYuStockChangeData message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ArcadeBuYuStockChangeData.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        w.uint32(8).int32(m.playId);
        w.uint32(16).int64(m.changeValue);
        return w;
    };

    /**
     * Decodes an ArcadeBuYuStockChangeData message from the specified reader or buffer.
     * @function decode
     * @memberof ArcadeBuYuStockChangeData
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {ArcadeBuYuStockChangeData} ArcadeBuYuStockChangeData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ArcadeBuYuStockChangeData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.ArcadeBuYuStockChangeData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
        ...
        if (!m.hasOwnProperty("playId"))
            throw $util.ProtocolError("missing required 'playId'", { instance: m });
        if (!m.hasOwnProperty("changeValue"))
            throw $util.ProtocolError("missing required 'changeValue'", { instance: m });
        return m;
    };

    return ArcadeBuYuStockChangeData;
})();

$root.ArcadeBuYuStockChange = (function() {

    /**
     * Properties of an ArcadeBuYuStockChange.
     * @exports IArcadeBuYuStockChange
     * @interface IArcadeBuYuStockChange
     * @property {Array.<IArcadeBuYuStockChangeData>|null} [changeValues] ArcadeBuYuStockChange changeValues
     * @property {Array.<IArcadeBuYuStockChangeData>|null} [taxChangeValues] ArcadeBuYuStockChange taxChangeValues
     */

    /**
     * Constructs a new ArcadeBuYuStockChange.
     * @exports ArcadeBuYuStockChange
     * @classdesc Represents an ArcadeBuYuStockChange.
     * @implements IArcadeBuYuStockChange
     * @constructor
     * @param {IArcadeBuYuStockChange=} [p] Properties to set
     */
    function ArcadeBuYuStockChange(p) {
        this.changeValues = [];
        this.taxChangeValues = [];
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
                    this[ks[i]] = p[ks[i]];
    ...
    /**
     * ArcadeBuYuStockChange changeValues.
     * @member {Array.<IArcadeBuYuStockChangeData>} changeValues
     * @memberof ArcadeBuYuStockChange
     * @instance
     */
    ArcadeBuYuStockChange.prototype.changeValues = $util.emptyArray;

    /**
     * ArcadeBuYuStockChange taxChangeValues.
     * @member {Array.<IArcadeBuYuStockChangeData>} taxChangeValues
     * @memberof ArcadeBuYuStockChange
     * @instance
     */
    ArcadeBuYuStockChange.prototype.taxChangeValues = $util.emptyArray;

    /**
     * Creates a new ArcadeBuYuStockChange instance using the specified properties.
     * @function create
     * @memberof ArcadeBuYuStockChange
     * @static
     * @param {IArcadeBuYuStockChange=} [properties] Properties to set
     * @returns {ArcadeBuYuStockChange} ArcadeBuYuStockChange instance
     */
    ArcadeBuYuStockChange.create = function create(properties) {
        return new ArcadeBuYuStockChange(properties);
    };

    /**
     * Encodes the specified ArcadeBuYuStockChange message. Does not implicitly {@link ArcadeBuYuStockChange.verify|verify} messages.
     * @function encode
     * @memberof ArcadeBuYuStockChange
     * @static
     * @param {IArcadeBuYuStockChange} m ArcadeBuYuStockChange message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ArcadeBuYuStockChange.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        if (m.changeValues != null && m.changeValues.length) {
            for (var i = 0; i < m.changeValues.length; ++i)
                $root.ArcadeBuYuStockChangeData.encode(m.changeValues[i], w.uint32(10).fork()).ldelim();
        }
        if (m.taxChangeValues != null && m.taxChangeValues.length) {
            for (var i = 0; i < m.taxChangeValues.length; ++i)
                $root.ArcadeBuYuStockChangeData.encode(m.taxChangeValues[i], w.uint32(18).fork()).ldelim();
        }
        return w;
    };

    /**
     * Decodes an ArcadeBuYuStockChange message from the specified reader or buffer.
     * @function decode
     * @memberof ArcadeBuYuStockChange
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {ArcadeBuYuStockChange} ArcadeBuYuStockChange
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ArcadeBuYuStockChange.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.ArcadeBuYuStockChange();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1:
                if (!(m.changeValues && m.changeValues.length))
                    m.changeValues = [];
                m.changeValues.push($root.ArcadeBuYuStockChangeData.decode(r, r.uint32()));
                break;
            case 2:
                if (!(m.taxChangeValues && m.taxChangeValues.length))
                    m.taxChangeValues = [];
                m.taxChangeValues.push($root.ArcadeBuYuStockChangeData.decode(r, r.uint32()));
                break;
            default:
                r.skipType(t & 7);
                break;
