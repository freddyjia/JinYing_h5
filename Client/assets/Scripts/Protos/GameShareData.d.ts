...
export interface IBrandRoadData {
    ...
    record: IBaiJiaLeRecord;
}

/** Represents a BrandRoadData. */
export class BrandRoadData implements IBrandRoadData {

    /**
     * Constructs a new BrandRoadData.
     * @param [p] Properties to set
     */
    constructor(p?: IBrandRoadData);

    /** BrandRoadData baseRoomId. */
    public baseRoomId: number;

    /** BrandRoadData playId. */
    public playId: number;

    /** BrandRoadData record. */
    public record: IBaiJiaLeRecord;

    /**
     * Creates a new BrandRoadData instance using the specified properties.
     * @param [properties] Properties to set
     * @returns BrandRoadData instance
     */
    public static create(properties?: IBrandRoadData): BrandRoadData;

    /**
     * Encodes the specified BrandRoadData message. Does not implicitly {@link BrandRoadData.verify|verify} messages.
     * @param m BrandRoadData message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IBrandRoadData, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a BrandRoadData message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns BrandRoadData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): BrandRoadData;
}

/** Properties of a ReqBrandRoadData. */
export interface IReqBrandRoadData {

    /** ReqBrandRoadData baseRoomId */
    baseRoomId: number;
}

/** Represents a ReqBrandRoadData. */
export class ReqBrandRoadData implements IReqBrandRoadData {

    /**
     * Constructs a new ReqBrandRoadData.
     * @param [p] Properties to set
     */
    constructor(p?: IReqBrandRoadData);
     ...
     * @param [properties] Properties to set
     * @returns ReqBrandRoadData instance
     */
    public static create(properties?: IReqBrandRoadData): ReqBrandRoadData;

    /**
     * Encodes the specified ReqBrandRoadData message. Does not implicitly {@link ReqBrandRoadData.verify|verify} messages.
     * @param m ReqBrandRoadData message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IReqBrandRoadData, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a ReqBrandRoadData message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns ReqBrandRoadData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): ReqBrandRoadData;
}

/** Properties of a RspBrandRoadData. */
export interface IRspBrandRoadData {

    /** RspBrandRoadData baseRoomId */
    baseRoomId: number;

    /** RspBrandRoadData records */
    records?: (IBaiJiaLeRecord[]|null);
}

/** Represents a RspBrandRoadData. */
export class RspBrandRoadData implements IRspBrandRoadData {

    /**
     * Constructs a new RspBrandRoadData.
     * @param [p] Properties to set
     */
    constructor(p?: IRspBrandRoadData);

    /** RspBrandRoadData baseRoomId. */
    public baseRoomId: number;

    /** RspBrandRoadData records. */
    public records: IBaiJiaLeRecord[];

    /**
     * Creates a new RspBrandRoadData instance using the specified properties.
     * @param [properties] Properties to set
     * @returns RspBrandRoadData instance
     */
    public static create(properties?: IRspBrandRoadData): RspBrandRoadData;

    /**
     * Encodes the specified RspBrandRoadData message. Does not implicitly {@link RspBrandRoadData.verify|verify} messages.
     * @param m RspBrandRoadData message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IRspBrandRoadData, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a RspBrandRoadData message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns RspBrandRoadData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): RspBrandRoadData;
}

/** Properties of a BaiJiaLeRecord. */
export interface IBaiJiaLeRecord {
...
/** Represents a BaiJiaLeRecord. */
export class BaiJiaLeRecord implements IBaiJiaLeRecord {

    /**
     * Constructs a new BaiJiaLeRecord.
     * @param [p] Properties to set
     */
    constructor(p?: IBaiJiaLeRecord);
     ...
     * @param [properties] Properties to set
     * @returns BaiJiaLeRecord instance
     */
    public static create(properties?: IBaiJiaLeRecord): BaiJiaLeRecord;

    /**
     * Encodes the specified BaiJiaLeRecord message. Does not implicitly {@link BaiJiaLeRecord.verify|verify} messages.
     * @param m BaiJiaLeRecord message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IBaiJiaLeRecord, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a BaiJiaLeRecord message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns BaiJiaLeRecord
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): BaiJiaLeRecord;
}

/** Properties of a RoomStatusData. */
export interface IRoomStatusData {
    ...
    seatRoleInfos?: (ISeatInfo[]|null);
}

/** Represents a RoomStatusData. */
export class RoomStatusData implements IRoomStatusData {

    /**
     * Constructs a new RoomStatusData.
     * @param [p] Properties to set
     */
    constructor(p?: IRoomStatusData);
    ...
    /** RoomStatusData seatRoleInfos. */
    public seatRoleInfos: ISeatInfo[];

    /**
     * Creates a new RoomStatusData instance using the specified properties.
     * @param [properties] Properties to set
     * @returns RoomStatusData instance
     */
    public static create(properties?: IRoomStatusData): RoomStatusData;

    /**
     * Encodes the specified RoomStatusData message. Does not implicitly {@link RoomStatusData.verify|verify} messages.
     * @param m RoomStatusData message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IRoomStatusData, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a RoomStatusData message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns RoomStatusData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): RoomStatusData;
}

/** Properties of an ArcadeBuYuStockChangeData. */
export interface IArcadeBuYuStockChangeData {
...
/** Represents an ArcadeBuYuStockChangeData. */
export class ArcadeBuYuStockChangeData implements IArcadeBuYuStockChangeData {

    /**
     * Constructs a new ArcadeBuYuStockChangeData.
     * @param [p] Properties to set
     */
    constructor(p?: IArcadeBuYuStockChangeData);
     ...
     * @param [properties] Properties to set
     * @returns ArcadeBuYuStockChangeData instance
     */
    public static create(properties?: IArcadeBuYuStockChangeData): ArcadeBuYuStockChangeData;
     ...
     * @param m ArcadeBuYuStockChangeData message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IArcadeBuYuStockChangeData, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes an ArcadeBuYuStockChangeData message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns ArcadeBuYuStockChangeData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): ArcadeBuYuStockChangeData;
}

/** Properties of an ArcadeBuYuStockChange. */
export interface IArcadeBuYuStockChange {

    /** ArcadeBuYuStockChange changeValues */
    changeValues?: (IArcadeBuYuStockChangeData[]|null);

    /** ArcadeBuYuStockChange taxChangeValues */
    taxChangeValues?: (IArcadeBuYuStockChangeData[]|null);
}

/** Represents an ArcadeBuYuStockChange. */
export class ArcadeBuYuStockChange implements IArcadeBuYuStockChange {

    /**
     * Constructs a new ArcadeBuYuStockChange.
     * @param [p] Properties to set
     */
    constructor(p?: IArcadeBuYuStockChange);

    /** ArcadeBuYuStockChange changeValues. */
    public changeValues: IArcadeBuYuStockChangeData[];

    /** ArcadeBuYuStockChange taxChangeValues. */
    public taxChangeValues: IArcadeBuYuStockChangeData[];

    /**
     * Creates a new ArcadeBuYuStockChange instance using the specified properties.
     * @param [properties] Properties to set
     * @returns ArcadeBuYuStockChange instance
     */
    public static create(properties?: IArcadeBuYuStockChange): ArcadeBuYuStockChange;
     ...
     * @param m ArcadeBuYuStockChange message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IArcadeBuYuStockChange, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes an ArcadeBuYuStockChange message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns ArcadeBuYuStockChange
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): ArcadeBuYuStockChange;
}
