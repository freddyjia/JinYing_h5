...
export interface IActionPlayCard {
    ...
    playCardType?: (PlayCardType|null);
...
export interface IRequestRefreshThreeCard {
}

/** Represents a RequestRefreshThreeCard. */
export class RequestRefreshThreeCard implements IRequestRefreshThreeCard {

    /**
     * Constructs a new RequestRefreshThreeCard.
     * @param [p] Properties to set
     */
    constructor(p?: IRequestRefreshThreeCard);

    /**
     * Creates a new RequestRefreshThreeCard instance using the specified properties.
     * @param [properties] Properties to set
     * @returns RequestRefreshThreeCard instance
     */
    public static create(properties?: IRequestRefreshThreeCard): RequestRefreshThreeCard;
     ...
     * @param m RequestRefreshThreeCard message or plain object to encode
     * @param [w] Writer to encode to
     * @returns Writer
     */
    public static encode(m: IRequestRefreshThreeCard, w?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a RequestRefreshThreeCard message from the specified reader or buffer.
     * @param r Reader or buffer to decode from
     * @param [l] Message length if known beforehand
     * @returns RequestRefreshThreeCard
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(r: ($protobuf.Reader|Uint8Array), l?: number): RequestRefreshThreeCard;
}
