...
var $root = $protobuf.roots.DouDiZhu || ($protobuf.roots.DouDiZhu = {});
...
$root.DouDiZhuMember = (function() {
     ...
     * @property {string|null} [city] DouDiZhuMember city
     * @property {string|null} [province] DouDiZhuMember province
     */
     ...
     * @instance
     */
    DouDiZhuMember.prototype.city = "";

    /**
     * DouDiZhuMember province.
     * @member {string} province
     * @memberof DouDiZhuMember
     * @instance
     */
    DouDiZhuMember.prototype.province = "";
...
$root.PushCountDown = (function() {
     ...
     * @property {Array.<number>|null} [cantQiang] PushCountDown cantQiang
     */
    ...
    /**
     * PushCountDown cantQiang.
     * @member {Array.<number>} cantQiang
     * @memberof PushCountDown
     * @instance
     */
    PushCountDown.prototype.cantQiang = $util.emptyArray;
    ...
    PushCountDown.encode = function encode(m, w) {
        ...
        if (m.cantQiang != null && m.cantQiang.length) {
            for (var i = 0; i < m.cantQiang.length; ++i)
                w.uint32(48).int32(m.cantQiang[i]);
        }
        return w;
    };
    ...
    PushCountDown.decode = function decode(r, l) {
        ...
        while (r.pos < c) {
            ...
            case 5:
                ...
                break;
            case 6:
                if (!(m.cantQiang && m.cantQiang.length))
                    m.cantQiang = [];
                if ((t & 7) === 2) {
                    var c2 = r.uint32() + r.pos;
                    while (r.pos < c2)
                        m.cantQiang.push(r.int32());
                } else
                    m.cantQiang.push(r.int32());
                break;
            default:
...
$root.DouDiZhuActionReq = (function() {
     ...
     * @property {number|null} [jiao] DouDiZhuActionReq jiao
     * @property {number|null} [qiang] DouDiZhuActionReq qiang
     ...
     * @instance
     */
    DouDiZhuActionReq.prototype.jiao = 0;
     ...
     * @instance
     */
    DouDiZhuActionReq.prototype.qiang = 0;
    ...
    DouDiZhuActionReq.encode = function encode(m, w) {
        ...
        if (m.jiao != null && m.hasOwnProperty("jiao"))
            w.uint32(16).int32(m.jiao);
        if (m.qiang != null && m.hasOwnProperty("qiang"))
            w.uint32(24).int32(m.qiang);
        if (m.cardInfo != null && m.cardInfo.length) {
            for (var i = 0; i < m.cardInfo.length; ++i)
...
$root.ActionJiaoRes = (function() {
     ...
     * @property {number} isJiao ActionJiaoRes isJiao
     ...
     * @member {number} isJiao
     * @memberof ActionJiaoRes
     * @instance
     */
    ActionJiaoRes.prototype.isJiao = 0;
...
$root.ActionQiangRes = (function() {
     ...
     * @property {number} isQiang ActionQiangRes isQiang
     ...
     * @member {number} isQiang
     * @memberof ActionQiangRes
     * @instance
     */
    ActionQiangRes.prototype.isQiang = 0;
...
$root.ActionPlayCard = (function() {
     ...
     * @property {number|null} [index] ActionPlayCard index
     * @property {PlayCardType|null} [playCardType] ActionPlayCard playCardType
    ...
    ActionPlayCard.encode = function encode(m, w) {
        ...
        if (m.index != null && m.hasOwnProperty("index"))
            w.uint32(8).int32(m.index);
        if (m.playCardType != null && m.hasOwnProperty("playCardType"))
...
$root.RequestRefreshThreeCard = (function() {

    /**
     * Properties of a RequestRefreshThreeCard.
     * @exports IRequestRefreshThreeCard
     * @interface IRequestRefreshThreeCard
     */

    /**
     * Constructs a new RequestRefreshThreeCard.
     * @exports RequestRefreshThreeCard
     * @classdesc Represents a RequestRefreshThreeCard.
     * @implements IRequestRefreshThreeCard
     * @constructor
     * @param {IRequestRefreshThreeCard=} [p] Properties to set
     */
    function RequestRefreshThreeCard(p) {
        if (p)
            for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null)
                    this[ks[i]] = p[ks[i]];
    ...
    /**
     * Creates a new RequestRefreshThreeCard instance using the specified properties.
     * @function create
     * @memberof RequestRefreshThreeCard
     * @static
     * @param {IRequestRefreshThreeCard=} [properties] Properties to set
     * @returns {RequestRefreshThreeCard} RequestRefreshThreeCard instance
     */
    RequestRefreshThreeCard.create = function create(properties) {
        return new RequestRefreshThreeCard(properties);
    };

    /**
     * Encodes the specified RequestRefreshThreeCard message. Does not implicitly {@link RequestRefreshThreeCard.verify|verify} messages.
     * @function encode
     * @memberof RequestRefreshThreeCard
     * @static
     * @param {IRequestRefreshThreeCard} m RequestRefreshThreeCard message or plain object to encode
     * @param {$protobuf.Writer} [w] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    RequestRefreshThreeCard.encode = function encode(m, w) {
        if (!w)
            w = $Writer.create();
        return w;
    };
    ...
    /**
     * Decodes a RequestRefreshThreeCard message from the specified reader or buffer.
     * @function decode
     * @memberof RequestRefreshThreeCard
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {RequestRefreshThreeCard} RequestRefreshThreeCard
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    RequestRefreshThreeCard.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.RequestRefreshThreeCard();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            default:
    ...
    return RequestRefreshThreeCard;
})();
